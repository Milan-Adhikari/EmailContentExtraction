...
def get_new_attachments(email_address: str, password:str , white_list: list[str], file_path: str, start_time:str, end_time:str, delete_read: bool) -> None:
    ...
    _, data = mail.uid('search', None, '(SINCE "{}" BEFORE "{}")'.format(start_time, end_time))
...
start_time = '2023-01-13 12:08:33'
end_time = '2023-01-14 13:00:00'

start_time= datetime.fromisoformat(start_time)
end_time = datetime.fromisoformat(end_time)


get_new_attachments(email_id, pwd, email_white_list, file_path, start_time.strftime(DATE_F), end_time.strftime(DATE_F), True)
